pipeline {
  ...
  environment {
    ...
    EXT_USER = 'melonDS-emu'
    EXT_REPO = 'melonDS'
    BUILD_VERSION_ARG = 'MELONDS_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-melonds'
    CONTAINER_NAME = 'melonds'
    DOCKERHUB_IMAGE = 'linuxserver/melonds'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/melonds'
    PR_DOCKERHUB_IMAGE = 'lspipepr/melonds'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-melonds/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-melonds\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-melonds\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Melonds\" \
          --label \"org.opencontainers.image.description=[melonDS](https://melonds.kuribo64.net/) aims at providing fast and accurate Nintendo DS emulation.\" \
